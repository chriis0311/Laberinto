...
def main_loop(mapa_matriz):
    ...
    while True:
        if coor_px == len(mapa_matriz) - 1 and coor_py == len(mapa_matriz[0]) - 1:
            ...
            if (
                coor_px - 1 >= 0
                and mapa_matriz[coor_px - 1][coor_py] != "#"
                and k == key.UP
            ):
                if k == key.UP:
                    coor_px -= 1
            ...
            # Derecha
                ...
                coor_py + 1 >= 0
                and mapa_matriz[coor_px][coor_py + 1] != "#"
                and k == key.RIGHT
            ):
                coor_py += 1
                if k == key.RIGHT:
...
main_loop(cambiar_caracteres_a_matriz(Laberinto))
